...
<head>
  ...
  <!-- DatePicker -->
	<link href="<?php echo base_url('assets/admin/date/css/datepicker.css')?>" rel="stylesheet">
  <!-- Toggle -->
	<link href="<?php echo base_url('assets/admin/bootstrap-toggle/css/bootstrap-toggle.min.css')?>" rel="stylesheet">
	<style>
