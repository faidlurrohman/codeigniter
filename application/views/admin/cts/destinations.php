        	...
        	<div class="col-xl-4 order-xl-2 mb-5 mb-xl-0">
          		<div class="card card-profile shadow">
    				<div class="card-header bg-white border-0">
          			...
          			<form action="<?php echo base_url('admin/destinations/add_destination_db')?>" method="post" enctype="multipart/form-data">
		            	<div class="card-body pt-0 pt-md-4">
      						<div class="form-group">
								<input type="text" id="nameDestination" name="nameDestination" class="form-control" placeholder="Name of Destination" autocomplete="off" style="text-transform: capitalize;" required>
      						</div>
      						<div class="form-group">
		                        <div class="input-group mb-3">
								  	<div class="custom-file">
								    	<input type="file" id="imageDestination" name="imageDestination" class="form-control-file" required>
							...
							?>
	                  			<tr>
				                    ...
				                    <td>
				                    	...
				                    	<a href="<?php echo base_url();?>delete-destination/<?= $destination->id ?>" class="badge badge-danger"><i class="fa fa-trash"></i>&nbsp;&nbsp;&nbsp;delete</a>
	                    			</td>
	                  			</tr>
							<?php
									}
