	...
	<?php
		$total_transports = $transports->num_rows();
						...
						<div class="wrap-division">
							...
							?>
									<div class="col-md-4 col-sm-6 animate-box">
										<div class="tour">
											<a href="<?= base_url(); ?>transport/<?= $transport->transportation_id ?>" class="tour-img" style="background-image: url(<?= base_url('assets/admin/img/transportations/'); ?><?= $transport->image ?>);">
												<p class="price"><span>$<?= $transport->price ?></span> <small>/ <?= $transport->duration ?> Days</small></p>
											</a>
											<span class="desc">
												<h2><a href="<?= base_url(); ?>transport/<?= $transport->transportation_id ?>"><?= $transport->name ?></a></h2>
